...
@section("content")
<section style="background-color: white" class="post-single">
        ...
        <div class="row ">
            <div class="col-lg-12">
                ...
                <div class="post-single-body">
                    ...
                    <div class="post-single-content" style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; hyphens: auto; max-width: 100%; color:rgb(58, 56, 56)">
                        {!! $post->content !!}
                    </div>
